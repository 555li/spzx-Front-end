...
import { GetSysUserListPage, SaveSysUser, UpdateSysUser, DeleteSysUser,DoAssignRoleToUser } from "@/api/sysUser";
...
const fetchData = async () => {
    ...
    const { data } = await GetSysUserListPage(pageParams.value.page,
        pageParams.value.limit, queryDto.value)
