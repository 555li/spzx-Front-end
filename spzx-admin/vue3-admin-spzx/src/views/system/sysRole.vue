...
import { DoAssignMenuIdToSysRole,GetSysRoleMenuIds,GetSysRoleListPage,SaveSysRole,UpdateSysRole,DeleteSysRole } from '@/api/sysRole'
...
const fetchData = async () => {
    const { data, code, message } = await GetSysRoleListPage(pageParams.value.page, pageParams.value.limit, queryDto.value)
...
const resetData = () => {
    pageParamsForm.page = 1
    pageParamsForm.limit = 3
